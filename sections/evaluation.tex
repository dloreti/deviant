...
The labeling for the \textsc{prod$_{rej}$} dataset distinguishes between executions with at least a rejected work order (negative traces) and executions with no rejected orders (positive traces) \cite{DBLP:journals/tkdd/TeinemaaDRM19}.}
...
\begin{table*} [h]
	...
	\scalebox{0.7}{
		...
		\toprule
			...
			\btext{\textsc{bpic12$_{CANC}$}} & \btext{\para{max}} & \btext{1} & \btext{100\%} & \btext{13} & \btext{1} & \btext{100\%} & \btext{5.07} & \btext{12.28} & \btext{22.28} & \btext{3.98}  \\ 
			\textsc{bpic12$_{mean}$} & \btext{\para{max}} & \btext{13} & \btext{0.91\%} & \btext{\para{max}}& \btext{13} & \btext{0.91\%} & \btext{2.84} & \btext{6.14} & \btext{15.65} & \btext{7.73}  \\ 
			\textsc{bpic12$_{median}$} & \btext{\para{max}} & \btext{21} & \btext{32.71\%} & \btext{\para{max}} & \btext{21} & \btext{32.71\%} & \btext{2.15} & \btext{7.19} & \btext{5.67} & \btext{77.62} \\ 	\midrule
			\btext{\textsc{cerv$_{compl}$}} & \btext{\para{max}} & \btext{4} & 100\% & \para{max} & 4 & 100\% & \btext{0.39} & \btext{0.08} & \btext{19.24} & \btext{0.08}\\ 
			\btext{\textsc{cerv$_{mean}$}} & \btext{\para{max}} & \btext{1} & \btext{100\%} & \btext{\para{max}}& \btext{1} & \btext{100\%} & \btext{0.01} & \btext{0.92} & \btext{10.22} & \btext{5.21}  \\ 
			\btext{\textsc{cerv$_{median}$}} & \btext{\para{max}} & \btext{1} & \btext{100\%} & \btext{1} & \btext{1} & \btext{100\%} & \btext{0.02} & \btext{0.97} & \btext{11.47} & \btext{7.04} \\ 	\midrule
			\btext{\textsc{dreyers$_{reset}$}} & \btext{\para{max}} & \btext{8} & \btext{98.56\%} & \btext{\para{max}} & \btext{8} & \btext{98.56\%} & \btext{1.67} & \btext{0.17} & \btext{16.42} & \btext{0.11}\\ 
			\btext{\textsc{dreyers$_{mean}$}} & \btext{\para{max}} & \btext{3} & \btext{100\%} & \btext{\para{max}}& \btext{3} & \btext{100\%} & \btext{0.56} & \btext{2.69} & \btext{20.03} & \btext{230.44}  \\ 
			\btext{\textsc{dreyers$_{median}$}} & \btext{\para{max}} & \btext{14} & \btext{96.94\%} & \btext{1} & \btext{14} & \btext{96.94\%} & \btext{1.14} & \btext{1.24} & \btext{10.89} & \btext{timeout} \\ 	\midrule
			%\btext{599.76} \\ 	\midrule
			\btext{\textsc{prod$_{rej}$}} & \btext{\para{max}} & \btext{21} & \btext{40.17\%} & \btext{1} & \btext{21} & \btext{40.17\%} & \btext{0.8} & \btext{0.54} & \btext{6.151} & \btext{timeout} \\
			%\btext{599.74}\\ 
			\btext{\textsc{prod$_{mean}$}} & \btext{\para{max}} & \btext{20} & \btext{81.94\%} & \btext{1}& \btext{20} & \btext{81.94\%} & \btext{0.72} & \btext{0.68} & \btext{7.19} & \btext{timeout}\\
			%\btext{599.74}  \\ 
			\btext{\textsc{prod$_{median}$}} & \btext{\para{max}} & \btext{25} & \btext{78.18\%} & \btext{1} & \btext{25} & \btext{78.18\%} & \btext{0.55} & \btext{0.96} & \btext{8.95} & \btext{timeout} \\ \midrule
			...
			\textsc{sepsis$_{mean}$} & \btext{\para{max}} & 8 & 4.25\% & \btext{\para{max}} & 8  & 4.25\% & 0.73 & \btext{0.29} & \btext{1.97} & \btext{0.05}\\ 
			\textsc{sepsis$_{median}$} &\btext{\para{max}} & \btext{13} & 26.86\% & \btext{\para{max}} & \btext{13} & 26.86\% & \btext{0.45} &	\btext{0.64} & \btext{2.52} & \btext{13.94} \\ \midrule
			...
			\btext{\textsc{traffic$_{mean}$}} & \btext{\para{max}} & \btext{11} & \btext{0.76\%} & \btext{\para{max}} & \btext{11}  & \btext{0.76\%} & \btext{18.85} & \btext{24.05} & \btext{2.18} & \btext{0.04}\\ 
			\btext{\textsc{traffic$_{median}$}} &\btext{\para{max}} & \btext{11} & \btext{0.75\%} & \btext{\para{max}} & \btext{11} & \btext{0.75\%} & \btext{15.71} &	\btext{27.67} & \btext{1.5} & \btext{0.05} \\ \midrule			
			\bottomrule
		\end{tabular}}
...
The table also shows that \nd is overall very fast for small datasets \btext{with \subsetclos (e.g., less than 30 seconds for \textsc{cerv}, \textsc{dreyers}, \textsc{prod} and \textsc{sepsis})}, while it requires some more time for large ones (e.g., \textsc{bpic12} and \textsc{traffic}). While the time required for computing \textit{compatibles} and \textit{\sheriff} seems to be related to the size of the dataset, the time required for computing the optimizations \btext{especially the \minclos} seems to depend also on other characteristics of the datasets.
