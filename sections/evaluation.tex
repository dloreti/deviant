...
\begin{table}[h]
	...
	\scalebox{0.65}{
		...
		\toprule
			...
			\btext{\textsc{traffic$_{median}$}} &  &  &  & \btext{median duration} & \btext{65\,003} & \btext{64\,6122} \\ \midrule		
			\bottomrule
		\end{tabular}}
...
\begin{table*} [h]
	...
	\scalebox{0.7}{
		...
		\toprule
			...
			\btext{\textsc{bpic12$_{CANC}$}} & \btext{>22} & \btext{1} & \btext{100\%} & \btext{13} & \btext{1} & \btext{100\%} & \btext{5.07} & \btext{12.28} & \btext{22.28} & \btext{3.98}  \\ 
			\textsc{bpic12$_{mean}$} & \btext{>146} & \btext{13} & \btext{1\%} & \btext{\para{max}}& \btext{13} & \btext{1\%} & \btext{2.84} & \btext{6.14} & \btext{15.65} & \btext{7.73}  \\ 
			\textsc{bpic12$_{median}$} & \btext{> 27} & \btext{21} & \btext{33\%} & \btext{\para{max}} & \btext{21} & \btext{33\%} & \btext{2.15} & \btext{7.19} & \btext{5.67} & \btext{77.62} \\ 	\midrule
			\btext{\textsc{cerv$_{compl}$}} & \btext{> 254} & \btext{4} & 100\% & \para{max} & 4 & 100\% & \btext{0.39} & \btext{0.08} & \btext{19.24} & \btext{0.08}\\ 
			...
			\btext{\textsc{cerv$_{median}$}} & \btext{> 21} & \btext{1} & \btext{100\%} & \btext{\para{max}} & \btext{1} & \btext{100\%} & \btext{0.02} & \btext{0.97} & \btext{11.47} & \btext{7.04} \\ 	\midrule
			\btext{\textsc{dreyers$_{reset}$}} & \btext{> 80} & \btext{8} & \btext{99\%} & \btext{\para{max}} & \btext{8} & \btext{99\%} & \btext{1.67} & \btext{0.17} & \btext{16.42} & \btext{0.11}\\ 
