...
In this work, we focus on declarative process models express in Declare syntax \cite{2008-Pesic} and embrace the less popular view of process discovery as a binary supervised learning task.
