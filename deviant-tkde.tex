...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{img/Tessaris.png}}]{Chiara Di Francescomarino}
TO DO
\end{IEEEbiography}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{img/Tessaris.png}}]{Marco Montali}
TO DO
\end{IEEEbiography}
